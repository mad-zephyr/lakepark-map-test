...
const logo = (animate: boolean): Variants => {
  return {
    initial: {
      opacity: 1,
...
const maskSymbol = (animate: boolean): Variants => {
  return {
    initial: {
      transform: 'translateY(0%)',
    },
...
const maskTitle = (animate: boolean): Variants => {
  return {
    initial: {
      transform: 'translateY(0%)',
    },
...
const maskSubtitle = (animate: boolean): Variants => {
  return {
    initial: {
      transform: 'translateY(0%)',
    },
